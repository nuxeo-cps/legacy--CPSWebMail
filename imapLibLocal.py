...
Commands = {
        # name            valid states
        'BODYSTRUCTURE': ('NONAUTH', 'AUTH', 'SELECTED'),
        'GETQUOTAROOT': ('NONAUTH', 'AUTH', 'SELECTED'),
        'SORT':   ('NONAUTH', 'AUTH', 'SELECTED', 'LOGOUT'),
        'APPEND':       ('AUTH', 'SELECTED'),
        'AUTHENTICATE': ('NONAUTH',),
        'CAPABILITY':   ('NONAUTH', 'AUTH', 'SELECTED', 'LOGOUT'),
        'STARTTLS':   ('NONAUTH', 'AUTH', 'SELECTED', 'LOGOUT'),
        'CHECK':        ('SELECTED',),
        'CLOSE':        ('SELECTED',),
        'COPY':         ('SELECTED',),
...
class IMAP4:
    ...
    def startTSL(self):
        ...
        (typ, [data]) = <instance>.check()
        """
        return self._simple_command('STARTTLS')
